...
export default function FleaAndTickSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">Built Specifically for Flea &amp; Tick Control</div>
        <h1>Flea &amp; Tick Control Software<br /><span>Built for How You Actually Work</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. SprayBossPro is built from the ground up for flea &amp; tick operators — the way you run recurring barrier treatments, route your re-treats, track your applications, and bill pet-owner customers is completely different, and your software should be too.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="SprayBossPro flea and tick control software dashboard on laptop showing circle-map route builder and waiting list, with mobile app on phone"
      ...
      <div className="premium-band">
        <h2>Affordable Doesn&apos;t Mean Cheap.<br /><span>This Is Enterprise-Level Flea &amp; Tick Software.</span></h2>
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Live route maps, drag-and-drop stop ordering, geographic clustering, and a waiting list that shows you total square footage per service type before you schedule a single barrier treatment. No other flea &amp; tick software has this.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Application Compliance</h4><p>Every flea &amp; tick application logged automatically with product mix, granular or spray, area treated, weather conditions, and tech license number. Pull a print-ready compliance report in under 30 seconds for any state inspector.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, invoicing, charge after service, payment tracking, overdue reports — the full Stripe integration is wired in. Your pet-owner customers can pay instantly and you can see every dollar collected in one place.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your technicians get a mobile-optimized dashboard with their stops for the day. Complete, skip, reschedule, log applications, and mark notes — all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a flea &amp; tick route we&apos;ve ever seen. Draw a circle on your service area map and SprayBossPro instantly surfaces every property inside that radius that has a barrier treatment due — with total square footage, service types, stops, and revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>No competitor has this. It doesn&apos;t exist anywhere else in flea &amp; tick software.</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                ...
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Sq Ft (Yard)</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#e07820', fontSize:'18px', fontWeight:800}}>4,200</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Linear Ft (Fence Line)</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Flea &amp; Tick · 8 &nbsp;|&nbsp; Mosquito · 6 &nbsp;|&nbsp; Perimeter Pest · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">The Most Capable Flea &amp; Tick Software Is Also the Easiest to Learn</h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Flea &amp; Tick Control</h2>
          <p className="section-sub">Flea &amp; tick control is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing hundreds of pet-owner properties, recurring re-treat intervals, square footage, chemical applications, and a waiting list that never stops growing.</p>
        </div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          <span className="section-label">Built for Flea &amp; Tick</span>
          <h2 className="section-title">Features Designed Around Your Operation</h2>
          <p className="section-sub">Every tool in SprayBossPro was built with flea &amp; tick workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Sq Ft Waiting List', body:'Before you schedule a single stop, SprayBossPro shows you the exact square footage waiting for every service type on your list. Know how much flea & tick, mosquito, or perimeter pest work you can fit in a day before you make a single call.'},
            ...
            {icon:'🧪', title:'Chemical Application Tracking', body:'Log every flea & tick application with the product mix, area treated, granular or spray, weather conditions, and technician name. Pull compliance reports instantly — no spreadsheet needed.'},
            {icon:'📦', title:'Recurring Barrier Programs', body:'Create seasonal spring-through-fall programs on 3-4 week re-treat intervals, assign clients to them, and track renewal dates. SprayBossPro alerts you when re-treats are coming due so nothing falls through the cracks.'},
            ...
            {icon:'💰', title:'Estimates That Close', body:'Build a flea & tick estimate in minutes with your service catalog, email it directly from the platform, and let clients accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            ...
            {icon:'🏠', title:'Property Profiles', body:'Every property has its own record — square footage, service history, application logs, notes, GPS coordinates, and photos. Everything tied to the address, not just the customer.'},
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Flea &amp; Tick Barrier</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Granular Tick 3</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Perimeter Pest 4</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 properties waiting</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              ...
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>No other flea &amp; tick software shows you this.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemical Tracking Built for Flea &amp; Tick Compliance</h2>
            <p>Every state requires pesticide application records. SprayBossPro makes compliance automatic — every flea &amp; tick application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
              <li>Log product mix, rate, and gallons applied per stop</li>
              <li>Track area type: turf, shrubs, fence line, wood edge, etc.</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Flea &amp; Tick Mix A · 8,200 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Sunny · 75°F</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Granular Tick · 12,000 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Partly Cloudy</div></div>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <ul className="price-features">
              ...
              <li>Recurring Barrier Programs &amp; Renewals</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Flea &amp; Tick Software — Common Questions</h2>
          {[
            {q:'Is SprayBossPro built for flea & tick businesses?', a:'Yes. SprayBossPro handles the full flea & tick operation: recurring barrier program scheduling, sq ft-based route building, chemical application logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running treatment routes, not general service businesses.'},
            {q:'Can I manage flea & tick as an add-on to my existing lawn or pest route?', a:'Yes. SprayBossPro supports multiple service types from one account, with separate waiting lists by service category. Flea & tick barrier treatments run right alongside your lawn, mosquito, and perimeter pest routes — with service-specific SMS alerts and independent pricing — so you can upsell pet-owner customers on the same platform.'},
            {q:'How does route building work for flea & tick?', a:'You open the circle-map lasso tool, draw a circle around a geographic area, and every flea & tick account due inside is selected and added to your route. Sq ft totals, stop count, and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does SprayBossPro track chemical applications for flea & tick treatments?', a:'Yes. Every treatment logs the product, EPA registration number, rate, and area treated — whether it\'s a granular application or a liquid barrier spray. The chemical compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Does it handle recurring seasonal re-treats?', a:'Yes. Flea & tick control is seasonal spring-through-fall on roughly 3-4 week re-treat intervals. SprayBossPro tracks each property\'s re-treat schedule, drops due accounts onto the waiting list automatically, and alerts you when barrier treatments are coming due so nothing falls through the cracks.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>SprayBossPro handles flea &amp; tick control alongside lawn care, weed control, mosquito spray, and perimeter pest — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

      {/* CTA */}
      <div className="cta-band">
        <h2>Stop Running Your Flea &amp; Tick Business<br />on Software Built for Plumbers.</h2>
        <p>SprayBossPro is the only flea &amp; tick management software built by someone who has actually run a spray route. Try it free for 14 days.</p>
        <div className="hero-btns">
