...
export default function PerimeterPestControlSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">Built Specifically for Perimeter Pest Control</div>
        <h1>Perimeter Pest Control Software<br /><span>Built for Recurring Barrier Programs</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. SprayBossPro is built from the ground up for perimeter pest control companies — the way you run recurring quarterly and bi-monthly barrier routes, track what&apos;s due, and bill a subscription program is completely different, and your software should be too.</p>
        <div className="hero-btns">
          <a href="#" onClick={(e) => { e.preventDefault(); openSignupModal(1, e.currentTarget as HTMLElement); }} className="btn-primary">Start Your 14-Day Free Trial</a>
          <div className="hero-trust">No credit card required &nbsp;&middot;&nbsp; 14-day free trial &nbsp;&middot;&nbsp; <b>from $59/mo</b> after</div>
        </div>
        <div className="hero-stats">
          <div><div className="hero-stat-val">Due</div><div className="hero-stat-lbl">Waiting List of What&apos;s Due Per Service</div></div>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="SprayBossPro perimeter pest control software dashboard on laptop showing circle-map route builder and recurring service waiting list, with mobile app on phone"
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Live route maps, drag-and-drop stop ordering, geographic clustering, and a waiting list that shows you exactly which recurring accounts are due for their next barrier treatment before you schedule a single stop. No other pest control software has this.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Application Compliance</h4><p>Every barrier application logged automatically with product mix, ounces or gallons applied, area treated, weather conditions, and tech license number. Pull a print-ready compliance report in under 30 seconds for any state inspector.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, recurring invoicing, charge after service, payment tracking, overdue reports — the full Stripe integration is wired in. Your subscription customers can pay instantly and you can see every dollar collected in one place.</p></div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>Draw a Circle on the Map. See Every Account Due Inside It.</h2>
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a pest control route we&apos;ve ever seen. Draw a circle on your service area map and SprayBossPro instantly surfaces every property inside that radius that has a recurring service due — with stops, service types, and revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see every account due inside</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#e07820', fontSize:'18px', fontWeight:800}}>14</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Quarterly Due</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#e07820', fontSize:'18px', fontWeight:800}}>5</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Bi-Monthly Due</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Perimeter Barrier · 12 &nbsp;|&nbsp; Mosquito · 4 &nbsp;|&nbsp; Interior Callback · 3</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. SprayBossPro is the exception. Every screen was designed by people who ran spray routes — not UX designers who&apos;ve never touched a spray rig. Your team will be using it confidently on day one.</p>
        </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Recurring Pest Control</h2>
          <p className="section-sub">Perimeter pest control is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing hundreds of subscription accounts, multiple recurring frequencies, barrier applications, and a waiting list of what&apos;s-due that never stops growing.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own spray routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>800 recurring accounts on a waiting list</strong> and need to know exactly how many quarterly barrier treatments are due before you schedule a single truck.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a recurring pest control program. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and SprayBossPro is the software we always wished existed.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in SprayBossPro exists because we needed it on a real spray route. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          <span className="section-label">Built for Perimeter Pest Control</span>
          <h2 className="section-title">Features Designed Around Your Operation</h2>
          <p className="section-sub">Every tool in SprayBossPro was built with recurring pest control workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'What&apos;s-Due Waiting List', body:'Before you schedule a single stop, SprayBossPro shows you exactly which recurring accounts are due for every service type on your list. Know how many quarterly barrier, bi-monthly, or mosquito treatments you can fit in a day before you make a single call.'},
            ...
            {icon:'🧪', title:'Chemical Application Tracking', body:'Log every barrier application with the product mix, area treated, ounces or gallons applied, weather conditions, and technician name. Pull compliance reports instantly — no spreadsheet needed.'},
            {icon:'📦', title:'Recurring Program Plans', body:'Create quarterly, bi-monthly, or custom recurring programs, assign clients to them, and track next-service dates. SprayBossPro drops each account onto the waiting list automatically when it comes due so nothing falls through the cracks.'},
            ...
            {icon:'💰', title:'Estimates That Close', body:'Build a pest control estimate in minutes with your service catalog, email it directly from the platform, and let clients accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            {icon:'💳', title:'Card-on-File Payments', body:'Store cards on file via Stripe. Charge after each recurring service, send invoices, and collect payments without chasing anyone down. Every dollar tracked in one place.'},
            ...
            {icon:'🏠', title:'Property Profiles', body:'Every property has its own record — service history, chemical logs, notes, gate codes, GPS coordinates, and photos. Everything tied to the address, not just the customer.'},
            ...
            {icon:'👥', title:'Client & Lead Management', body:'Manage existing subscription clients and active prospects side by side. Track estimates, service history, and notes all tied to each contact — with a full searchable database.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Recurring Program Scheduling</span>
            <h2>Know Exactly What&apos;s Due Before You Schedule a Single Stop</h2>
            <p>This is the feature no other pest control software has. SprayBossPro&apos;s waiting list doesn&apos;t just show you which properties need service — it groups every recurring account that&apos;s due by service type so you know exactly how much you can fit in a day before you start making calls. For a closer look at how the waiting list works as the daily operational hub for a recurring pest control business, read <a href="/blogs/perimeter-pest-control-scheduling-software" style={{color:'var(--orange)', fontWeight:600}}>How Perimeter Pest Control Scheduling Software Runs Your Recurring Program</a></p>
            <ul className="check-list">
              <li>Waiting list grouped by service type and recurring frequency</li>
              ...
              <li>Summary bar: total stops and revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Quarterly Barrier</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 properties due</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>47 due</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Bi-Monthly Barrier</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 properties due</div></div>
              <div style={{marginLeft:'auto', background:'#e07820', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>31 due</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#5bbfff', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Mosquito Treatment</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 properties due</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>22 due</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Interior Callback</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 properties due</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>15 due</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              ...
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>No other pest control software shows you this.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemical Tracking Built for Pest Control Compliance</h2>
            <p>Every state requires pesticide application records. SprayBossPro makes compliance automatic — every barrier application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
              <li>Log product mix, rate, and amount applied per stop</li>
              <li>Track area type: exterior perimeter, interior, eaves, etc.</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#e07820', fontSize:'20px', fontWeight:700}}>186</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Barriers Treated</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Perimeter Barrier Mix A</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Sunny · 75°F</div></div>
              <div style={{background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>3 gal</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Interior Callback</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Partly Cloudy</div></div>
              <div style={{background:'#e07820', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>1 gal</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Perimeter Pest Control Software — Common Questions</h2>
          {[
            {q:'Is SprayBossPro built for perimeter pest control businesses?', a:'Yes. SprayBossPro handles the full recurring pest control operation: quarterly and bi-monthly program scheduling, what\'s-due route building, barrier application logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running recurring treatment routes, not general service businesses.'},
            {q:'Can I manage multiple service types — perimeter barrier, mosquito, interior callbacks — in one platform?', a:'Yes. SprayBossPro supports multiple service types from one account, with separate waiting lists by service category. You can run quarterly perimeter barrier, bi-monthly, mosquito, and interior callback routes simultaneously with service-specific SMS alerts and independent pricing.'},
            {q:'How does route building work for perimeter pest control?', a:'You open the circle-map lasso tool, draw a circle around a geographic area, and every recurring account due inside is selected and added to your route. Stop count and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does SprayBossPro track chemical applications for pest control?', a:'Yes. Every barrier treatment logs the product, EPA registration number, rate, and area treated. The chemical compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Does it handle recurring subscription billing?', a:'Yes. SprayBossPro stores cards on file via Stripe and lets you charge after each recurring service, send invoices, and track every payment. Recurring program plans drop each account onto the waiting list automatically when it comes due, so your subscription route never misses a cycle.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>SprayBossPro handles perimeter pest control alongside weed control, fertilizer, lawn care, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

      {/* CTA */}
      <div className="cta-band">
        <h2>Stop Running Your Pest Control Business<br />on Software Built for Plumbers.</h2>
        <p>SprayBossPro is the only perimeter pest control management software built by someone who has actually run a recurring spray route. Try it free for 14 days.</p>
        <div className="hero-btns">
