...
async function sbpCreateAccount(n: number) {
  ...
  try {
    ...
    const iv = setInterval(() => {
      secs--;
      if (secs <= 0) { clearInterval(iv); window.location.href = 'https://my.spraybosspro.com/dashboard.html' + (typeof signInData!=='undefined'&&signInData&&signInData.session?'#access_token='+encodeURIComponent(signInData.session.access_token)+'&refresh_token='+encodeURIComponent(signInData.session.refresh_token):''); }
    ...
    <div id={`sbp-form-${n}`} className="sbp-form">
      ...
      <div id={`sbp${n}-step1`} className="sbp-form-body">
        ...
        <div className="sbp-field">
          ...
          <input id={`sbp${n}-company`} type="text" placeholder="Smith Tree Care" className="sbp-input" />
        </div>
...
export default function TreeAndShrubCareSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">Built Specifically for Tree &amp; Shrub Care</div>
        <h1>Tree &amp; Shrub Care Software<br /><span>Built for How You Actually Work</span></h1>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="SprayBossPro tree and shrub care software dashboard on laptop showing circle-map route builder and treatment waiting list, with mobile app on phone"
      ...
      <div className="premium-band">
        <h2>Affordable Doesn&apos;t Mean Cheap.<br /><span>This Is Enterprise-Level Tree &amp; Shrub Care Software.</span></h2>
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Live route maps, drag-and-drop stop ordering, geographic clustering, and a waiting list that shows you exactly how many properties are due for each treatment program before you schedule a single stop. No other tree and shrub care software has this.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Spray &amp; Injection Compliance</h4><p>Every spray and trunk injection logged automatically with product mix, amount applied, target pest or disease, weather conditions, and tech license number. Pull a print-ready compliance report in under 30 seconds for any state inspector.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your technicians get a mobile-optimized dashboard with their stops for the day. Complete, skip, reschedule, log sprays and injections, and mark notes — all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a tree and shrub care route we&apos;ve ever seen. Draw a circle on your service area map and SprayBossPro instantly surfaces every property inside that radius that has a treatment due — with stops, service types, and revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see all properties inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops and revenue by treatment type automatically</li>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across all your treatment programs simultaneously in one view</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Cuts route-building time from an hour to under 5 minutes</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>No competitor has this. It doesn&apos;t exist anywhere else in tree and shrub care software.</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                ...
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Total Treatments</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#e07820', fontSize:'18px', fontWeight:800}}>62</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Trees Due</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#e07820', fontSize:'18px', fontWeight:800}}>28</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Shrub Beds Due</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Deep-Root Feed · 8 &nbsp;|&nbsp; Insect &amp; Disease · 6 &nbsp;|&nbsp; Trunk Injection · 5</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Breakdown by Treatment Type</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">The Most Capable Tree &amp; Shrub Care Software Is Also the Easiest to Learn</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. SprayBossPro is the exception. Every screen was designed by people who ran treatment routes — not UX designers who&apos;ve never touched a spray rig or an injection unit. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            {n:'01', title:'Set Up in One Afternoon', body:'Add your treatment programs, import your clients and properties, set up your automated alerts, and connect Stripe — most owners are fully operational the same day they sign up. No implementation consultant, no onboarding call, no 90-day setup timeline.'},
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, waiting list, map, and application log are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day is right there in a single view.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Tree &amp; Shrub Care</h2>
          <p className="section-sub">Tree and shrub care is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing hundreds of properties, seasonal treatment programs, dormant oil and deep-root rounds, spray and injection logs, and a waiting list that never stops growing.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own spray routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>800 properties on a waiting list</strong> and need to know exactly how many deep-root feedings or insect and disease treatments you have waiting before you schedule a single truck.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a tree and shrub care business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and SprayBossPro is the software we always wished existed.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in SprayBossPro exists because we needed it on a real treatment route. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          <span className="section-label">Built for Tree &amp; Shrub Care</span>
          <h2 className="section-title">Features Designed Around Your Operation</h2>
          <p className="section-sub">Every tool in SprayBossPro was built with tree and shrub care workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Treatment Waiting List', body:'Before you schedule a single stop, SprayBossPro shows you exactly how many properties are waiting for every treatment type on your list. Know how many deep-root feedings, insect and disease treatments, or trunk injections you can fit in a day before you make a single call.'},
            ...
            {icon:'🧪', title:'Spray & Injection Tracking', body:'Log every spray and trunk injection with the product mix, target pest or disease, amount applied, weather conditions, and technician name. Pull compliance reports instantly — no spreadsheet needed.'},
            {icon:'📦', title:'Seasonal Program Plans', body:'Create dormant oil, deep-root fertilization, and insect and disease program plans, assign clients to them, and track each recurring round. SprayBossPro alerts you when the next seasonal round is coming due so nothing falls through the cracks.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when a treatment is scheduled, when your tech is on the way, and when the job is done. Set it once — SprayBossPro handles the communication for every single stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a tree and shrub care estimate in minutes with your treatment catalog, email it directly from the platform, and let clients accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            ...
            {icon:'🏠', title:'Property Profiles', body:'Every property has its own record — tree and shrub inventory, program history, spray and injection logs, notes, GPS coordinates, and photos. Everything tied to the address, not just the customer.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After every completed treatment, SprayBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
            ...
            {icon:'👥', title:'Client & Lead Management', body:'Manage existing clients and active prospects side by side. Track estimates, program history, and notes all tied to each contact — with a full searchable database.'},
            ...
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards on your dashboard show today\'s revenue, treatments completed, properties served, money owed, and more — all at a glance the moment you log in.'},
            {icon:'🔔', title:'10+ Automated Alert Types', body:'Treatment scheduled, completed, skipped, rescheduled, estimate sent, estimate accepted, review request, payment declined, inbound text — all automated, all customizable.'},
            {icon:'👥', title:'Unlimited Clients', body:'Add every employee, office staff member, and technician at no extra cost. No per-seat fees. Unlimited clients are included in the flat from $59/month rate.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Tree &amp; Shrub Care Scheduling</span>
            <h2>Know Exactly How Much Work Is Waiting Before You Schedule a Single Stop</h2>
            <p>This is the feature no other tree and shrub care software has. SprayBossPro&apos;s waiting list doesn&apos;t just show you what properties need service — it shows you the total waiting broken down by treatment type so you know exactly how much you can fit in a day before you start making calls. For a closer look at how the waiting list works as the daily operational hub for a tree and shrub care business, read <a href="/blogs/tree-and-shrub-care-scheduling-software" style={{color:'var(--orange)', fontWeight:600}}>Tree &amp; Shrub Care Scheduling Software: How to Run Seasonal Treatment Rounds</a></p>
            <ul className="check-list">
              <li>Waiting list grouped by treatment type with property totals</li>
              ...
              <li>Summary bar: total stops, treatments, revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Waiting List — By Treatment Type</div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Deep-Root Feeding</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 properties waiting</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>212 trees</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Insect &amp; Disease</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 properties waiting</div></div>
              <div style={{marginLeft:'auto', background:'#e07820', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>148 shrubs</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#5bbfff', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Dormant Oil</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 properties waiting</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>96 trees</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Trunk Injection</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 properties waiting</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>54 trees</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              ...
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>No other tree and shrub care software shows you this.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Spray &amp; Injection Tracking Built for Tree &amp; Shrub Care Compliance</h2>
            <p>Every state requires pesticide application records — and that includes trunk injections and soil drenches, not just foliar sprays. SprayBossPro makes compliance automatic — every application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
              <li>Log product mix, rate, and amount applied per stop</li>
              <li>Track application method: foliar spray, trunk injection, soil drench</li>
          ...
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Application Log — June 2026</div>
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#e07820', fontSize:'20px', fontWeight:700}}>642</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Trees Treated</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Deep-Root Feed · 12 trees</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Sunny · 75°F</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Trunk Injection · 6 oaks</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Partly Cloudy</div></div>
              <div style={{background:'#e07820', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>9 units</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Tree &amp; Shrub Care Software — Common Questions</h2>
          {[
            {q:'Is SprayBossPro built for tree and shrub care businesses?', a:'Yes. SprayBossPro handles the full tree and shrub care operation: seasonal program scheduling, map-based route building, spray and trunk injection logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running treatment routes, not general service businesses.'},
            {q:'Can I manage multiple treatment types — deep-root feeding, insect and disease, dormant oil, injections — in one platform?', a:'Yes. SprayBossPro supports multiple treatment types from one account, with separate waiting lists by treatment category. You can run deep-root fertilization, insect and disease control, dormant oil, and trunk injection rounds simultaneously with treatment-specific SMS alerts and independent pricing.'},
            {q:'How does route building work for tree and shrub care?', a:'You open the circle-map lasso tool, draw a circle around a geographic area, and every property with a treatment due inside is selected and added to your route. Stop count, treatment breakdown, and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does SprayBossPro track sprays and injections for compliance?', a:'Yes. Every foliar spray, soil drench, and trunk injection logs the product, EPA registration number, rate, and amount applied. The compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Does it handle recurring seasonal treatment rounds?', a:'Yes. Build dormant oil, deep-root, and insect and disease program plans, assign clients to them, and SprayBossPro tracks each recurring round and alerts you when the next seasonal treatment is due — so no property is ever missed between rounds.'},
            {q:'How much does SprayBossPro cost?', a:'from $59/month, all features included. No hidden fees, no add-ons for SMS or route tools, no setup fees. 14-day free trial with no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>SprayBossPro handles tree and shrub care alongside lawn care, weed control, fertilizer, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

      {/* CTA */}
      <div className="cta-band">
        <h2>Stop Running Your Tree &amp; Shrub Care Business<br />on Software Built for Plumbers.</h2>
