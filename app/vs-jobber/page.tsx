  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Jobber Is Built for Every Industry.<br /><span>SprayBossPro Is Built for Yours.</span></h1>
        <p>Jobber is a solid general-purpose field service tool. But "general purpose" means it wasn't designed around square footage waiting lists, chemical compliance logs, the lasso route selector, or the way lawn care and pest control businesses actually schedule recurring spray routes. SprayBossPro was.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'900px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">SprayBossPro vs Jobber</h2>
        ...
        <div className="compare-wrap">
          <table className="compare-table">
            ...
            <tbody>
              ...
              <tr><td className="feature-name">Starting Price (Annual Billing)</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800, fontSize:'15px'}}>$59 / month</td><td style={{color:'var(--muted)'}}>$29/mo (1 user only)</td></tr>
              <tr><td className="feature-name">Price for a 5-Person Team (Annual)</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800}}>$59 / month</td><td style={{color:'var(--muted)'}}>$149/mo (Connect — no SMS)</td></tr>
              <tr><td className="feature-name">Price with Two-Way SMS (Annual)</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800}}>$59 / month</td><td style={{color:'var(--muted)'}}>$299/mo (Grow — up to 10 users)</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <div className="premium-band">
        <h2>Jobber Charges More as You Grow.<br /><span>SprayBossPro Charges $59. Period.</span></h2>
        <p>The moment you add your 6th employee on Jobber, you&apos;re bumped to a higher tier. Add more features, pay more. Add more users, pay more. SprayBossPro has one price — from $59/month — that covers your entire team, every feature, forever. No surprises. No per-seat math. No surprises on your invoice.</p>
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">📋</div><h4>Sq Ft Waiting List</h4><p>Before you schedule a single stop, SprayBossPro shows you the total square footage waiting per service type. Know exactly how much Lawn Care 4, Mosquito, or Insect Control you can fit before you call anyone. Jobber has no concept of this.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💬</div><h4>True Two-Way SMS Inbox</h4><p>Send and receive text messages inside SprayBossPro with full conversation history per contact. Jobber has limited client messaging — not a full SMS inbox with inbound/outbound history organized by customer.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Clients, One Price</h4><p>Every employee — techs, office staff, managers — included at from $59/month. Jobber charges per tier based on user count. Add your 6th employee and your bill goes up. Ours doesn&apos;t.</p></div>
        </div>
      </div>
        ...
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <ul className="check-list">
              ...
              <li>from $59/month — add 20 employees, price doesn&apos;t change</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">SprayBossPro</div><div className="mock-sub">Unlimited clients — every feature — SMS included</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px'}}>
              <div style={{color:'var(--orange)', fontSize:'13px', fontWeight:700, marginBottom:'8px'}}>SprayBossPro also includes things Jobber doesn&apos;t:</div>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Draw a circle on your service area map and SprayBossPro instantly shows every property inside that radius with a service due — total stops, service types, sq ft, all calculated before you schedule a single stop. Jobber has route optimization. That&apos;s completely different from Lasso. No competitor has built anything like this.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Jobber has been around for years and has a solid UI. But SprayBossPro was designed specifically for the way spray businesses work — which means less configuration, less hunting through menus, and a dispatch board that actually makes sense for recurring service routes.</p>
        </div>
        <div className="simple-grid">
          ...
          <div className="simple-card"><div className="simple-num">04</div><h3>Automation That Actually Runs</h3><p>SMS alerts, estimate follow-ups, payment reminders, review requests — set them up once and SprayBossPro runs them every time, automatically. You&apos;re not babysitting automations or configuring Zapier workflows.</p></div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">One Price. Every Feature. Unlimited Clients.</h2>
          <p className="section-sub">No surprises. No per-seat fees. No upgrade prompts. Just from $59/month for your entire operation.</p>
        </div>
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="price-card featured" style={{width:'100%'}}>
            ...
            <div className="price-desc">Every feature. Unlimited clients, properties, employees, and users. No surprises, no per-seat fees, no locked features.</div>
