  ...
  return (
    <>
      ...
      <div className="premium-band">
        <h2>Jobber Charges More as You Grow.<br /><span>SprayBossPro Charges $129. Period.</span></h2>
        <p>The moment you add your 6th employee on Jobber, you&apos;re bumped to a higher tier. Add more features, pay more. Add more users, pay more. SprayBossPro has one price — $129/month — that covers your entire team, every feature, forever. No tiers. No per-seat math. No surprises on your invoice.</p>
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">SprayBossPro</div><div className="mock-sub">Unlimited users — every feature — SMS included</div></div>
