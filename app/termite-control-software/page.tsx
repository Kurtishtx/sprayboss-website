...
export default function TermiteControlSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">Built Specifically for Termite Control</div>
        <h1>Termite Control Business Software<br /><span>Built for How You Actually Work</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. SprayBossPro is built from the ground up for termite control companies — the way you inspect, treat, monitor, and renew warranties is completely different, and your software should be too.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="SprayBossPro termite control software dashboard on laptop showing circle-map route builder and inspection waiting list, with mobile app on phone"
      ...
      <div className="premium-band">
        <h2>Affordable Doesn&apos;t Mean Cheap.<br /><span>This Is Enterprise-Level Termite Control Software.</span></h2>
        ...
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your technicians get a mobile-optimized dashboard with their inspections and treatments for the day. Complete, skip, reschedule, log chemicals, and mark notes — all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a termite route we&apos;ve ever seen. Draw a circle on your service area map and SprayBossPro instantly surfaces every property inside that radius with an inspection, treatment, or warranty renewal due — with total square footage, service types, stops, and revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>No competitor has this. It doesn&apos;t exist anywhere else in termite control software.</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                ...
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Sq Ft (Structure)</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#e07820', fontSize:'18px', fontWeight:800}}>4,200</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Linear Ft (Perimeter)</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>WDO Inspection · 8 &nbsp;|&nbsp; Barrier Treatment · 6 &nbsp;|&nbsp; Bait Monitoring · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">The Most Capable Termite Control Software Is Also the Easiest to Learn</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. SprayBossPro is the exception. Every screen was designed by people who ran treatment routes — not UX designers who&apos;ve never touched a sub-slab rig. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'03', title:'Your Techs Learn It in Minutes', body:'The mobile app your technicians use shows them exactly what they need and nothing they don\'t. Their inspections and treatments for the day, the property info, the job notes, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Termite Control</h2>
          <p className="section-sub">Termite control is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing hundreds of properties, multiple service types, square footage, chemical applications, warranty renewals, and a waiting list that never stops growing.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own treatment routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>800 properties on a waiting list</strong> and need to know exactly how much square footage of barrier treatment you have waiting before you schedule a single truck.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a termite control business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and SprayBossPro is the software we always wished existed.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in SprayBossPro exists because we needed it on a real termite control route. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          <span className="section-label">Built for Termite Control</span>
          <h2 className="section-title">Features Designed Around Your Operation</h2>
          <p className="section-sub">Every tool in SprayBossPro was built with termite control workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Sq Ft Waiting List', body:'Before you schedule a single stop, SprayBossPro shows you the exact square footage waiting for every service type on your list. Know how many WDO inspections, barrier treatments, or bait monitoring visits you can fit in a day before you make a single call.'},
            {icon:'🗺️', title:'Live Route Map', body:'See every scheduled inspection and treatment pinned on an interactive map. Drag to reorder stops, build tight geographic routes, and cut drive time before your crew ever leaves the yard.'},
            {icon:'🧪', title:'Chemical Application Tracking', body:'Log every liquid barrier and bait application with the product mix, area treated, gallons applied, weather conditions, and technician name. Pull compliance reports instantly — no spreadsheet needed.'},
            {icon:'📦', title:'Recurring Program Scheduling', body:'Create annual warranty renewal and bait-station monitoring programs, assign clients to them, and track renewal dates. SprayBossPro alerts you when renewals and monitoring visits are coming due so nothing falls through the cracks.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when an inspection is scheduled, when your tech is on the way, and when the job is done. Set it once — SprayBossPro handles the communication for every single stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a termite treatment estimate in minutes with your service catalog, email it directly from the platform, and let clients accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            ...
            {icon:'📱', title:'Mobile App for Technicians', body:'Your techs get a mobile-optimized view of their inspections and treatments for the day. Mark jobs complete, skip, or reschedule — right from the truck without calling the office.'},
            {icon:'🏠', title:'Property Profiles', body:'Every property has its own record — square footage, inspection and treatment history, chemical logs, warranty notes, GPS coordinates, and photos. Everything tied to the address, not just the customer.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After every completed inspection or treatment, SprayBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Termite Control Scheduling</span>
            <h2>Know Exactly How Much Work Is Waiting Before You Schedule a Single Stop</h2>
            <p>This is the feature no other termite control software has. SprayBossPro&apos;s waiting list doesn&apos;t just show you what properties need service — it shows you the total square footage broken down by service type so you know exactly how much you can fit in a day before you start making calls. For a closer look at how the waiting list works as the daily operational hub for a termite control business, read <a href="/blogs/termite-control-scheduling-software" style={{color:'var(--orange)', fontWeight:600}}>What Is Termite Control Scheduling Software and Does Your Business Actually Need It?</a></p>
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>WDO Inspection</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Liquid Barrier Treatment</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Bait Station Monitoring</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Warranty Renewal</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 properties waiting</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              ...
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>No other termite control software shows you this.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemical Tracking Built for Termite Control Compliance</h2>
            <p>Every state requires pesticide application records. SprayBossPro makes compliance automatic — every liquid barrier and bait application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
              <li>Log product mix, rate, and gallons applied per stop</li>
              <li>Track area type: perimeter, sub-slab, crawlspace, etc.</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Liquid Barrier Mix A · 8,200 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Sunny · 75°F</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Bait Station Refresh · 12,000 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Partly Cloudy</div></div>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <ul className="price-features">
              ...
              <li>Recurring Programs &amp; Warranty Renewals</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Termite Control Software — Common Questions</h2>
          {[
            {q:'Is SprayBossPro built for termite control businesses?', a:'Yes. SprayBossPro handles the full termite control operation: recurring program scheduling for warranty renewals and bait-station monitoring, sq ft-based route building, chemical application logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running inspection and treatment routes, not general service businesses.'},
            {q:'Can I manage multiple service types — WDO inspections, barrier treatments, bait monitoring — in one platform?', a:'Yes. SprayBossPro supports multiple service types from one account, with separate waiting lists by service category. You can run WDO inspection, liquid barrier treatment, bait-station monitoring, and warranty renewal routes simultaneously with service-specific SMS alerts and independent pricing.'},
            {q:'How does route building work for termite control?', a:'You open the circle-map lasso tool, draw a circle around a geographic area, and every termite account due inside is selected and added to your route. Sq ft totals, stop count, and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does SprayBossPro track chemical applications for termite control?', a:'Yes. Every liquid barrier and bait application logs the product, EPA registration number, rate, and area treated. The chemical compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Can it handle warranty renewals and bait-station monitoring?', a:'Yes. Recurring program scheduling drives annual warranty renewal inspections and bait-station monitoring visits, alerting you when each is due. Property profiles hold the full inspection history, notes, and photos for each address, so you always know what was found and treated on the last visit.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>SprayBossPro handles termite control alongside WDO inspections, barrier treatments, bait monitoring, and warranty renewals — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

      {/* CTA */}
      <div className="cta-band">
        <h2>Stop Running Your Termite Control Business<br />on Software Built for Plumbers.</h2>
        <p>SprayBossPro is the only termite control management software built by someone who has actually run a treatment route. Try it free for 14 days.</p>
        <div className="hero-btns">
