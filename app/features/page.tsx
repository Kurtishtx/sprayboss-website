  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>SprayBossPro is built specifically for lawn care, pest control, and spray. Every feature listed here is included in your from $59/month — nothing locked, nothing extra.</p>
        ...
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Auto-Routing Included',d:'50 auto-routes a month on Start, 100 on Pro, 1,000 on Crew. Need more? 250 are added automatically for $5. Smart Lasso selections are unlimited on every plan.'},
        ...
        <div className="cat-block">
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Unlimited Clients & Properties',d:'No caps. 50 accounts or 5,000 — same flat price, no surprises.'},
            ].map((f,i) => (
              <div key={i} className="feat-item"><div className="feat-item-title">{f.t}</div><p>{f.d}</p></div>
            ))}
          </div>
      ...
      <div className="dark-cat">
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          <div className="cat-header">
            <span className="cat-icon">👥</span>
            <div><div className="cat-title">Team Management &amp; Access Control</div><div className="cat-desc">Unlimited clients with role-based permissions from full access down to field-only</div></div>
          </div>
          <div className="feat-grid">
            {[
              {t:'Unlimited Clients',d:'Add every employee — techs, office staff, managers — at no extra cost. No hidden fees, ever.'},
