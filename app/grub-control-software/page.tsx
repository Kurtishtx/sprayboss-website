...
export default function GrubControlSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">Built Specifically for Grub Control</div>
        <h1>Grub Control Business Software<br /><span>Built for How Treatment Routes Actually Run</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. SprayBossPro is built from the ground up for grub control and lawn treatment operators — the way you time preventive windows, price by square foot, route applications, and log chemicals is completely different, and your software should be too.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="SprayBossPro grub control software dashboard on laptop showing circle-map route builder and square-footage waiting list, with mobile app on phone"
      ...
      <div className="premium-band">
        <h2>Affordable Doesn&apos;t Mean Cheap.<br /><span>This Is Enterprise-Level Grub Control Software.</span></h2>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a grub control route we&apos;ve ever seen. When the preventive window opens, draw a circle on your service area map and SprayBossPro instantly surfaces every property inside that radius that has an application due — with total square footage, service types, stops, and revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>No competitor has this. It doesn&apos;t exist anywhere else in grub control software.</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Grub Preventive · 8 &nbsp;|&nbsp; Grub Curative · 6 &nbsp;|&nbsp; Insect · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">The Most Capable Grub Control Software Is Also the Easiest to Learn</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. SprayBossPro is the exception. Every screen was designed by people who ran treatment routes — not UX designers who&apos;ve never touched a spreader or spray rig. Your team will be using it confidently on day one.</p>
        </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Grub Control</h2>
          <p className="section-sub">Grub control is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing hundreds of properties, a tight preventive window, square footage, chemical applications, and a waiting list that has to clear before the grubs hatch.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own treatment routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>800 properties on a waiting list</strong> and need to know exactly how many square feet of preventive grub applications you have waiting before the window closes and you schedule a single truck.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a lawn treatment business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and SprayBossPro is the software we always wished existed.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in SprayBossPro exists because we needed it on a real grub control route. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          <span className="section-label">Built for Grub Control</span>
          <h2 className="section-title">Features Designed Around Your Operation</h2>
          <p className="section-sub">Every tool in SprayBossPro was built with grub control and lawn treatment workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Sq Ft Waiting List', body:'Before you schedule a single stop, SprayBossPro shows you the exact square footage waiting for every service type on your list. Know how much preventive grub, curative grub, or insect control you can fit in a day before you make a single call.'},
            ...
            {icon:'🧪', title:'Chemical Application Tracking', body:'Log every grub application with the product mix, area treated, gallons applied, weather conditions, and technician name. Pull compliance reports instantly — no spreadsheet needed.'},
            {icon:'📦', title:'Lawn Treatment Program Plans', body:'Build grub control into a full-season treatment program, assign clients to it, and track renewal dates. SprayBossPro alerts you when applications are coming due so nothing falls through the cracks.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when an application is scheduled, when your tech is on the way, and when the job is done. Set it once — SprayBossPro handles the communication for every single stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a grub control estimate in minutes with your service catalog and square-footage pricing, email it directly from the platform, and let clients accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After every completed application, SprayBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
            ...
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards on your dashboard show today\'s revenue, applications completed, properties served, money owed, and more — all at a glance the moment you log in.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Grub Control Scheduling</span>
            <h2>Know Exactly How Much Square Footage Is Waiting Before the Window Closes</h2>
            <p>This is the feature no other grub control software has. SprayBossPro&apos;s waiting list doesn&apos;t just show you what properties need an application — it shows you the total square footage broken down by service type so you know exactly how much you can fit before the preventive window ends. For a closer look at how the waiting list works as the daily operational hub for a grub control business, read <a href="/blogs/grub-control-scheduling-software" style={{color:'var(--orange)', fontWeight:600}}>Grub Control Scheduling Software: How to Clear the Preventive Window on Time</a></p>
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Grub Preventive</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Grub Curative</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Insect Control</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 properties waiting</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Fertilizer + Grub</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 properties waiting</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              ...
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>No other grub control software shows you this.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemical Tracking Built for Grub Control Compliance</h2>
            <p>Every state requires pesticide application records. SprayBossPro makes compliance automatic — every grub application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Grub Preventive · 8,200 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Sunny · 75°F</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#e07820', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Grub Curative · 12,000 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Partly Cloudy</div></div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Grub Control Software — Common Questions</h2>
          {[
            {q:'Is SprayBossPro built for grub control businesses?', a:'Yes. SprayBossPro handles the full grub control operation: preventive and curative application scheduling, sq ft-based route building, chemical application logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running treatment routes, not general service businesses.'},
            {q:'Can I price grub applications by square footage?', a:'Yes. Square-footage pricing is core to SprayBossPro. Every property stores its treated square footage, your estimates and invoices calculate off that number, and the waiting list totals square feet by service type so you know exactly how much preventive or curative grub work is waiting before you route a truck.'},
            {q:'How does route building work for grub control?', a:'You open the circle-map lasso tool, draw a circle around a geographic area, and every grub application due inside is selected and added to your route. Sq ft totals, stop count, and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map — critical when the preventive window is only open for a few weeks.'},
            {q:'Does SprayBossPro track chemical applications for grub control?', a:'Yes. Every grub treatment logs the product, EPA registration number, rate, and area treated. The chemical compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Can grub control be part of a full-season program?', a:'Yes. Build grub control into a recurring lawn treatment program alongside fertilizer, weed control, and insect applications. Assign clients to the program, track renewal dates, and let SprayBossPro alert you when each application comes due so grubs never slip past the window.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>SprayBossPro handles grub control alongside weed control, fertilizer, pest control, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

      {/* CTA */}
      <div className="cta-band">
        <h2>Stop Running Your Grub Control Business<br />on Software Built for Plumbers.</h2>
        <p>SprayBossPro is the only grub control management software built by someone who has actually run a treatment route. Try it free for 14 days.</p>
        <div className="hero-btns">
