  ...
  return (
    <>
      ...
      <div className="premium-band">
        <h2>Every Feature a Mosquito Spray Business Needs.<br /><span>from $59/Month. Nothing Locked Behind Upgrades.</span></h2>
        ...
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Card-on-File Payments</h4><p>Collect payment automatically after each mosquito treatment. Card-on-file payments included at from $59/month — no payment add-on required.</p></div>
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>your whole crew</h4><p>Add as many technicians as you run mosquito routes. SprayBossPro doesn&apos;t cap users. Run 1 truck or 10 — the price stays the same.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">from $59/Month. Every Mosquito Spray Feature Included.</h2>
          <p className="section-sub">Simple plans. No add-ons for SMS, route building, or compliance logs. No user caps. No per-technician fees.</p>
        </div>
      ...
      <div className="cta-band">
        ...
        <p>SprayBossPro is from $59/month — schedule mosquito treatments, build routes with Lasso, log every application, and send automated SMS alerts from day one. No add-ons required.</p>
        <div className="hero-btns">
